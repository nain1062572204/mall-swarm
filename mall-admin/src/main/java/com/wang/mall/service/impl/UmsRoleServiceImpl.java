...
import com.wang.mall.dao.UmsRoleDao;
import com.wang.mall.dao.UmsRolePermissionRelationDao;
...
import com.wang.mall.mapper.UmsRoleResourceRelationMapper;
...
public class UmsRoleServiceImpl implements UmsRoleService {
    ...
    public int updatePermission(Long roleId, List<Long> permissionIds) {
        ...
        for (Long permissionId : permissionIds) {
            UmsRolePermissionRelation relation = UmsRolePermissionRelation.builder()
                    .roleId(roleId)
